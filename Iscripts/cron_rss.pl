...
# Init
my ($m, $cfg, $lng) = Irene::IreneMain->newShell(forumId => $forumId, spawned => $spawned);
...
sub writeRss200
{
	...
	print $fh
		...
		"    <ttl>120</ttl>\n",
		"    <generator>IreneForum $Irene::IreneMain::VERSION</generator>\n";
...
sub writeAtom10
{
	...
	print $fh
		...
		"  <generator version='$Irene::IreneMain::VERSION' uri='https://example.com'>IreneForum</generator>\n",
	;
