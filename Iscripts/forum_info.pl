...
print
	...
	"<tr class='crw'><td class='hco'>$lng->{fifGenVer}</td><td>$Irene::IreneMain::VERSION</td></tr>\n",
...
print 
	...
	"<div class='ccl'>\n",
    "<p>This forum, IreneForum is a fork of the below software.",
    " &#169; 2020 Chris Bennett</p>\n",
...
my $server = undef;
if ($Irene::IreneMain::MP1) { 
	$server = Apache::Constants::SERVER_VERSION();
}
elsif ($Irene::IreneMain::MP2) { 
