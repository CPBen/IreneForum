...
},
{
	...
	radio    => [
		SMTP     => "Use SMTP server via Irene::IreneSendmail",
		...
		sendmail => "Use sendmail command (path and options can be set in Irene::Config.pm)",
...
},
{
	...
	help     => "One Language=Module pair per line. Don't delete the Irene::Lang::English.pm file, even if you don't enable it here.",
	example  => [ "English=Irene::Lang::English" ],
	default  => { English => "Irene::Lang::English", Spanish => "Irene::Lang::Spanish", German => "Irene::Lang::German" },
},
{
	name     => 'languageCodes',
	type     => 'textarea',
	...
	help     => "One code=Language pair per line. Code must be in lowercase. Used for automatic language selection by HTTP <a href='https://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.4'>Accept-Language</a> header for new users and guests.",
	example  => [ "en=English" ],
	default  => { en => "English", es => "Spanish", de => "German" },
},
{
	name     => 'styles',
	type     => 'textarea',
...
},
{
	...
	example  => [ "https://www.myopenid.com/", "https://www.livejournal.com/" ],
	default  => [],
},
{
...
},
{
	...
	help     => "See <a href='https://en.gravatar.com/'>gravatar.com</a>. Only use with square dimensions configured below.",
	default  => 0,
},
{
	name     => 'avatarResize',
...
},
{
	...
	example  => [ 
		...
		"[vid=html]https://example.org/test.webm[/vid]",
	],
	default  => 0,
},
{
...
},
{
	...
	example  => [ "/irenedata/attach", "https://attach.example.org/irenedata" ],
	default  => "",
},
{
	name     => 'attachList',
...
},
{
	...
	help     => "Only needs to be modified if you are using multiple forums where one script path is a substring of another (e.g. /perl/ireneforum and perl/ireneforum2) or when you change the cookie domain and/or path.",
	example  => [ "ireneforum_" ],
	default  => "ireneforum_",
},
{
	...
	help     => "If your site is available at https://example.com and https://www.example.com then set cookieDomain to 'example.com' to allow login cookies to work with either hostname. If you change this in an established forum, also change the cookie prefix string.",
	example  => [ "example.com" ],
	default  => "",
},
{
...
},
{
	...
	help     => "Use first or second implementation if you can't install additional Perl modules. If a non-standard Captcha.pm module is installed, this selection has no effect. See FAQ.html for details.",
	radio    => [
...
},
{
	...
	help     => "Tells robots not to index this forum, should using <a href='https://www.robotstxt.org/wc/robots.html'>robots.txt</a> be impossible. Regardless of setting, tag is always used on pages other than forum, board and topic pages.",
	default  => 0,
},
{
	name     => 'sslOnly',
	...
	help     => "Signals that only secured connections are used. IreneForum will then set the secure flag for cookies. Enforcement of SSL/TLS is up to the webserver. Make sure <var>\$cfg-&gt;{baseUrl}</var> starts with https. You might also want to configure <a href='https://en.wikipedia.org/wiki/HTTP_Strict_Transport_Security'>Strict Transport Security</a> headers with the <var>httpHeader</var> forum option below.",
	default  => 0,
},
{
	name     => 'fileMode',
	type     => 'text',
	title    => "File access mode for attachments and other IreneForum-created files",
...
},
{
	name     => 'dirMode',
	type     => 'text',
	title    => "File access mode for IreneForum-created directories",
...
},
{
	...
	help     => "One subtype=Irene::PlgModuleName::functionName definition per line, multiple plugins of the same subtype are allowed.",
	example  => [ "top=Irene::PlgExample::printAds" ],
	default  => {},
},
{
	name     => 'msgDisplayPlg',
	...
	help     => "One Irene::PlgModuleName::functionName definition per line.",
	example  => [ "Irene::PlgExample::moreSmileys" ],
	default  => [],
},
{
	name     => 'logPlg',
	...
	title    => "Event plugins",
	help     => "One Irene::PlgModuleName::functionName definition per line.",
	example  => [ "Irene::PlgExample::userRegisterQueue" ],
	default  => [],
},
{
	name     => 'authzPlg',
	...
	help     => "One subtype=Irene::PlgModuleName::functionName definition per line.",
	example  => [ "viewBoard=Irene::PlgExample::viewBoard" ],
	default  => {},
},
{
	name     => 'authenPlg',
	...
	help     => "One subtype=Irene::PlgModuleName::functionName definition.",
	example  => [ "request=Irene::PlgExample::authenRequest" ],
	default  => {},
},
];

#------------------------------------------------------------------------------
# Database tables used by IreneForum
